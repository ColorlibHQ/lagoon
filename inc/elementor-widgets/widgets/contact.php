 ...
 * @since 1.0
 */
class Lagoonlogistics_Contact extends Widget_Base {

    public function get_name() {
        return 'lagoonlogistics-contact';
    }

    public function get_title() {
        return __( 'Contact', 'lagoonlogistics' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'contact_info',
            [
                'label' => __( 'Contact Info', 'lagoonlogistics' ),
            ]
        );

        $this->add_control(
            'info', [
                'label'         => __( 'Create Contact Info', 'lagoonlogistics' ),
                ...
                'fields'  => [
                    [
                        ...
                        'default'     => esc_html__( 'Dhaka, Bangladesh', 'lagoonlogistics' )
                    ],
                    [
                        'name'    => 'desc',
                        'label'   => __( 'Contact Descriptions', 'lagoonlogistics' ),
                        'type'    => Controls_Manager::TEXTAREA,
                        'default' => esc_html__( 'Write something...', 'lagoonlogistics' )
                    ],
                    [
                        'name'  => 'icon',
                        'label' => __( 'Icon', 'lagoonlogistics' ),
                        'type'  => Controls_Manager::ICON,
                        'options' => lagoonlogistics_themify_icon()
                    ]
        ...
        $this->start_controls_section(
            'contact_form',
            [
                'label' => __( 'Contact Form', 'lagoonlogistics' ),
            ]
        );
        $this->add_control(
            'contact_form_title',
            [
                'label'     => esc_html__( 'Contact Form Title', 'lagoonlogistics' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__('Get in Touch', 'lagoonlogistics')
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'color_title', [
                'label'     => __( 'Address Title Color', 'lagoonlogistics' ),
        ...
        $this->add_control(
            'color_desc', [
                'label'     => __( 'Address Description Color', 'lagoonlogistics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#777',
                'selectors' => [
        ...
        $this->add_control(
            'color_icon', [
                'label'     => __( 'Icon Color', 'lagoonlogistics' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#f7631b',
                'selectors' => [
