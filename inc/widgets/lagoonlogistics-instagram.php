...
----------------------------------------*/
class lagoonlogistics_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('lagoonlogistics_instagram_photo',esc_html__('[ Lagoonlogistics ] Intagram Photo','lagoonlogistics'),array(
			'description' => esc_html__('Lagoonlogistics Instagram Photo Widget','lagoonlogistics'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'lagoonlogistics');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'lagoonlogistics'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'lagoonlogistics'); ?></label>
...
if(!function_exists('lagoonlogistics_instagram_widgets')):
	function lagoonlogistics_instagram_widgets(){
		register_widget('lagoonlogistics_instagram_photo');
	}
	add_action('widgets_init','lagoonlogistics_instagram_widgets');
endif;
