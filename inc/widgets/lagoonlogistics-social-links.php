...
class Lagoonlogistics_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'lagoonlogistics_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Lagoonlogistics ] Social Links', 'lagoonlogistics' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'lagoonlogistics' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'lagoonlogistics' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'lagoonlogistics'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'lagoonlogistics'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'lagoonlogistics'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'behance' ) ); ?>"><?php esc_html_e( 'Behance URL:' ,'lagoonlogistics'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'lagoonlogistics'); ?></label>
...
} // Class lagoonlogistics_social_links ends here


// Register and load the widget
function lagoonlogistics_social_links_widget_load() {
	register_widget( 'Lagoonlogistics_social_links' );
}
add_action( 'widgets_init', 'lagoonlogistics_social_links_widget_load' );