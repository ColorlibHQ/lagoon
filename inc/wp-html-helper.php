...
// image default alt
if( !function_exists( 'lagoonlogistics_img_default_alt' ) ){
	function lagoonlogistics_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'lagoonlogistics_img_tag' ) ){
	function lagoonlogistics_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = lagoonlogistics_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'lagoonlogistics_anchor_tag' ) ){
	function lagoonlogistics_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'lagoonlogistics_heading_tag' ) ){
	function lagoonlogistics_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'lagoonlogistics_paragraph_tag' ) ){
	function lagoonlogistics_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'lagoonlogistics_other_tag' ) ){
	function lagoonlogistics_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'lagoonlogistics_button_element ' ) ){
	function lagoonlogistics_button_element( array $args ){
